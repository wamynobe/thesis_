...
\(1\times10^{-4}\). For Setups~2, 3, 5, and~6, the Transformer layers are
unfrozen after 2{,}000 updates and training continues to 40{,}000 updates;
Setup~4 retains the 5{,}000-update unfreeze point and 30{,}000-update training
budget selected for that backbone. After unfreezing, the Transformer is
