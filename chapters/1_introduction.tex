...
\begin{enumerate}
  \item Compare five tone classification setups---a CNN baseline trained on mel-spectrograms, three Wav2Vec~2.0 variants differing in their initialisation and adaptation data (learner-only fine-tuning, AISHELL-1 native-speech adaptation~\cite{bu2017aishell}, and a Chinese-specific checkpoint), and one Chinese HuBERT variant---on recordings of Polish learners of Mandarin.
